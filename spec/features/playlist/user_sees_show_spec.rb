...
describe 'user visits playlist show page' do
  before(:each) do
    ...
    @song_3 = @artist_2.songs.create(title: 'Valio la pena', length: 232, bpm: 120, dance: 'Salsa', link: "http://youtube.com", playlist_id: @playlist_2.id)
  end
  ...
  describe 'user clicks on song title' do
    xit 'should take user to song show page' do
